...
- **Evidencia del Proyecto:**
  - 📄 [Haz clic aquí para ver el PDF con la Presentación y Diagramas Técnicos](https://github.com/isroyal8514/robot-arduino-control/blob/main/IsraelReyes.pdf) *(Nota: este link funcionará cuando subas el PDF)*
