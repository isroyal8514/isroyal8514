...
- **Evidencia del Proyecto:**
  - 🚀 [Haz clic aquí para ver la Página Web funcionando en vivo (Vercel)](https://panama-nexus.vercel.app) *(Nota: cambia esto por tu link real de Vercel)*
...
- **Evidencia del Proyecto:**
  - 📄 [Haz clic aquí para ver el PDF con la Presentación y Diagramas Técnicos](https://github.com/isroyal8514/robot-arduino-control/blob/main/Presentacion_Robot.pdf) *(Nota: este link funcionará cuando subas el PDF)*
